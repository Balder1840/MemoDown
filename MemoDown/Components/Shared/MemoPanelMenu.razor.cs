// https://github.com/radzenhq/radzen-blazor/blob/master/Radzen.Blazor/RadzenPanelMenu.razor.cs
...
namespace MemoDown.Components.Shared
{
    ...
    {/// <summary>
     ...
     /// <value><c>true</c> if multiple items can be expanded; otherwise, <c>false</c>.</value>
        ...
        internal void CollapseAll(IEnumerable<MemoPanelMenuItem> itemsToSkip)
        {
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            {
                CollapseAll(Enumerable.Empty<MemoPanelMenuItem>());
            }
        ...
        internal void SelectItem(MemoPanelMenuItem item)
        {
        ...
        List<MemoPanelMenuItem> currentItems;
        ...
        internal bool IsFocused(MemoPanelMenuItem item)
        {
            return currentItems?.IndexOf(item) == focusedIndex && focusedIndex != -1;
        }

        internal void RemoveItem(MemoPanelMenuItem item)
        {
            items.Remove(item);
